            ...
            <section>
                <div className="row mt-4 ">
                    <ul className="nav nav-pills gap-2">
                        {languages.map((titolo) => (
                            <li className="nav-item">
                                <a className="nav-link active bg-warning text-dark" key={titolo.id} onClick={() => bottone(titolo.id)} href="#">
                                    {titolo.title}
                                </a>
                            </li>
                        ))}
